...
public class Constants {
	...
	//public static final String SERVER_IP = "http://10.170.41.117:8080/booksfloating";// 内网服务器ip（这里是随便写的一个地址）
	public static final String SERVER_IP = "http://y409448446.zicp.io/booksfloating";// 外网服务器ip（这里是随便写的一个地址）
