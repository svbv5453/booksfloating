...
public class Constants {
	...
	//public static final String SERVER_IP = "http://10.170.63.48:8080/booksfloating";// 内网服务器ip（这里是随便写的一个地址）
	public static final String SERVER_IP = "http://peaker.nat123.net/booksfloating";// 外网服务器ip（这里是随便写的一个地址）
